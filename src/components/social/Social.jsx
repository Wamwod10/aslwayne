...
const Social = () => {
  const platforms = [
    ...
    {
      name: 'Spotify',
      count: '18 900+ Oylik Tinglovchilar',
      color: '#1DB954',
  ...
  return (
    <div id='Social' className='social'>
      ...
      <div className="music__news-card">
        ...
        <p className="music__news-count">63 200+ Oylik Tinglovchilar</p>
